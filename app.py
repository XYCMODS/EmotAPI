...
async def perform_emote(team_code: str, uids: list, emote_id: int):
    ...
    try:
        ...
        await asyncio.sleep(0.14)  # ✅ server sync
        ...
        await asyncio.sleep(0.05)  # ✅ emote finish buffer
...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14203111160')  # <-- FIXED BOT UID

    Uid, Pw = '4359219182', 'ABHISHEK_1SVH4_BY_SPIDEERIO_GAMING_DN578'
